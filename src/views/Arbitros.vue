                ...
                <div class="filters-grid">
                    ...
                    <div class="form-group" style="margin-bottom: 0">
                        ...
                        <div style="display: flex; gap: 8px">
                            ...
                            <button
                                class="btn"
                                style="height: 38px; padding: 0 12px; display: flex; align-items: center; gap: 6px; white-space: nowrap"
                                @click="toggleSortDirection"
                                :title="sortDirection === 'asc' ? 'Orden: Avanzado a Inicial' : 'Orden: Inicial a Avanzado'"
                            >
                                <i :class="sortDirection === 'asc' ? 'ti ti-sort-ascending' : 'ti ti-sort-descending'"></i>
                                {{ sortDirection === 'asc' ? 'Avanzado → Inicial' : 'Inicial → Asistente...' }}
                            </button>
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    ...
                    >
                        <div>
                            ...
                            <div class="card-sub">
                                Árbitros con licencia, viaje o inactivos
                                temporales
                            </div>
                        </div>
